...
use webull_unofficial::utils::{generate_req_id, get_account_type, hash_password};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let trading_pin =
        env::var("WEBULL_TRADING_PIN").expect("WEBULL_TRADING_PIN not set for live trading");
    ...
    for is_paper in &[true, false] {
        ...
        let login_response = tester
            .make_request("POST", &login_url, Some(login_data), false, false, true)
            .await?;
        ...
        if *is_paper {
            ...
            let paper_response = tester
                .make_request("GET", &paper_account_url, None, false, false, true)
                .await?;
            ...
            let account_response = tester
                .make_request("GET", &account_id_url, None, false, false, true)
                .await?;
            ...
            let trade_token_response = tester
                .make_request(
                    "POST",
                    &trade_token_url,
                    Some(trade_token_data),
                    false,
                    false,
                    true,
                )
        ...
        let account_details = tester
            .make_request("GET", &account_url, None, false, false, true)
            .await?;
        ...
        let ticker_response = tester
            .make_request("GET", &ticker_url, None, false, false, true)
            .await?;
            ...
            for ticker in data {
                    ...
                    || ticker.get("symbol").and_then(|v| v.as_str()) == Some("PROK")
                {
                    if let Some(ticker_id) = ticker.get("tickerId") {
                        ...
                        println!(
                            "   ✓ Found PROK, ticker_id: {}",
                            prok_ticker_id.as_ref().unwrap()
                        );
                        break;
                    }
                }
        ...
        if let Some(ticker_id) = &prok_ticker_id {
            ...
            let quotes_response = tester
                .make_request("GET", &quotes_url, None, false, false, true)
                .await?;
            ...
            let bars_response = tester
                .make_request("GET", &bars_url, None, false, false, true)
                .await?;
            ...
            let orders_response = tester
                .make_request("GET", &orders_url, None, !is_paper, false, true)
                .await?;
            ...
            let orders_after_response = tester
                .make_request("GET", &orders_url, None, !is_paper, false, true)
                .await?;
            ...
            if let Some(orders) = orders_data.as_array() {
                for order in orders {
                    if let Some(order_id) = order.get("orderId") {
                        ...
                        save_response(
                            &mode_dir,
                            &format!("12_cancel_{}", order_id_str),
                            &cancel_response,
                        )
                        .await?;
            ...
            let news_response = tester
                .make_request("GET", &news_url, None, false, false, true)
                .await?;
            ...
            let options_response = tester
                .make_request("GET", &options_url, None, false, false, true)
                .await?;
            ...
            let fundamentals_response = tester
                .make_request("GET", &fundamentals_url, None, false, false, true)
                .await?;
        ...
        let logout_response = tester
            .make_request("POST", &logout_url, None, false, false, true)
            .await?;
